import 'package:clubz/club_profile1v.dart';
import 'package:clubz/club_profile2v.dart';
import 'package:clubz/widgets/club_card.dart';
import 'package:clubz/widgets/user_profile.dart';
        ...
        //TextField
          Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: Color.fromARGB(255, 175, 175, 175),blurRadius: 2, spreadRadius: 1)]
              ),
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: const OutlineInputBorder(
                      borderRadius: BorderRadius.all(Radius.circular(30)),
                      borderSide: BorderSide(color: Color.fromARGB(255, 21, 96, 143)),
                    ),
              ...
              child: Card(
                ...
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Club_profile1v()),);
                      },
                      child: Padding(
                        padding: const EdgeInsets.fromLTRB(10, 0, 10, 10),
                        child: ClipRRect(
              ...
              child: Card(
                ...
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Club_profile2v()),);
                      },
                      child: Padding(
                        padding: const EdgeInsets.fromLTRB(10, 0, 10, 10),
                        child: ClipRRect(
